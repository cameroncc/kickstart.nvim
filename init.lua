...
-- Show fiel name in terminal tab title
vim.o.title = true
...
vim.keymap.set('n', '<leader>tz', ':vsplit | terminal zsh<CR>i', { noremap = true, silent = true })
    ...
    config = function()
      ...
      require('todo-comments').setup {
        ...
        search = {
          ...
          pattern = [[\b(KEYWORDS)\s(:|-)]], -- ripgrep regex (match with colon or hyphen)
